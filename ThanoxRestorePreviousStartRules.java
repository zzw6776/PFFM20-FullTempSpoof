public class ThanoxRestorePreviousStartRules {
    private static final String[] TARGET_RULES = new String[]{
    ...
    private static final String[] REMOVE_RULES = new String[]{
